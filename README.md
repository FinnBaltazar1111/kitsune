# Kitsune
Clone of [**kitsuneoffline**](https://github.com/LiEnby/kitsuneoffline) modified to run in the web with it's default features like save state management, with some new features like a cheat engine.
